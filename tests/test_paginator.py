...
from plutto.paginator import paginate, parse_link, parse_link_headers, request


class TestParseLink:
    def test_link_over_empty_dictionary(self):
        next_url = "https://sandbox.getplutto.com/api/v1/customers?page=2"
        dictionary = {}
    ...
    def test_link_over_used_dictionary(self):
        next_url = "https://sandbox.getplutto.com/api/v1/customers?page=2"
        last_url = "https://sandbox.getplutto.com/api/v1/customers?page=13"
    ...
    def test_overwrite_dictionary(self):
        curr_url = "https://sandbox.getplutto.com/api/v1/customers?page=2"
        next_url = "https://sandbox.getplutto.com/api/v1/customers?page=4"
        last_url = "https://sandbox.getplutto.com/api/v1/customers?page=13"
...
class TestRequest:
    ...
    def test_request_response(self):
        ...
        assert isinstance(data["elements"]["resource_doesnt_exists"], list)
...
class TestPaginate:
    ...
    def test_pagination(self):
        client = httpx.Client(base_url="https://test.com")
        data = paginate(client, "/movements", "resource_doesnt_exists", {})
